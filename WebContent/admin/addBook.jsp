								...
								<tbody>
									<tr>
										...
										<td><input type="text" maxlength="100"
											style="width: 300px;" name="booksName" id="title" /></td>
									</tr>
									<tr>
										<td >分类：</td>
										<td><input type="text" maxlength="200"
											style="width: 300px;" name="category" id="title" /></td>
									</tr>
									<tr>
										<td>关键字：</td>
										<td><input type="text" maxlength="200"
											style="width: 300px;" name="keyWords" id="title" /></td>
									</tr>
									<tr>
									<td>备注：</td>
										<td><input type="text" maxlength="200"
											style="width: 300px;" name="remarks" value="无备注" id="title" /></td>
									</tr>
							...
							<table cellspacing="1" cellpadding="4" width="720" border="0">
								<tr>
									<td align="center"><br> <input type="submit"
										value="添加图书" onclick="return checkform();" class="button" />
									</td>
								</tr>
							</table>
						</form>
