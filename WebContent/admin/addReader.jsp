								...
								<tbody>
									<tr>
										...
										<td><input type="text" maxlength="100"
											style="width: 300px;" name="readersName" id="title" /></td>
									</tr>
									<tr>
										<td >密码：</td>
										<td><input type="text" maxlength="200"
											style="width: 300px;" name="password" id="title" /></td>
									</tr>
									<tr>
										<td>性别：</td>
										<td><input type="text" maxlength="200"
											style="width: 300px;" name="sex" id="title" /></td>
									</tr>
									<tr>
									<td>选择分类：</td>
							...
							<table cellspacing="1" cellpadding="4" width="720" border="0">
								<tr>
									<td align="center"><br> <input type="submit"
										value="添加读者" onclick="return checkform();" class="button" />
									</td>
								</tr>
							</table>
						</form>
