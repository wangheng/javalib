						...
						<div class="postcontent">
							...
							<table>
								...
								<tr>
									...
									<td><p><%=book.getBooksName()%></p></td>
									<td><p><%=book.getCategory()%></p></td>
									<td><p><%=book.getRemarks()%></p></td>
									<td><a
										href="
<%int readersId = reader.getId();
				int booksId = book.getId();
				out.print("/library/BorrowManage?method=add&readersId="
						+ readersId + "&booksId=" + booksId);%>
">借阅</a></td>
								</tr>
								<%
									}
